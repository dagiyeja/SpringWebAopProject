...
<div id="black_bg">
			...
			<div class="info-box wide-box">
				...
				<div>
					<p>
<img src="images/img4.jpg" class="photo2" alt="" /> <strong>At vero eos et accusamus</strong> et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos  dolores et quas molestias excepturi sint occaecati cupiditate non provident, <a href="#">similique sunt in culpa</a> qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda.
					</p>
				</div>
			</div>
			<div class="clear"></div>
	...
	<div class="content-container middle-side">
		<div class="info-box">
			...
			<div class="align-content">
				<p><img src="images/img1.jpg" class="photo" alt="" /></p>
				<p>
					Curabitur metus sem, bibendum a bibendum nec, accumsan a nisi..
				</p>
			</div>
		...
		<div class="info-box">
			...
			<div class="align-content">
				<p><img src="images/img2.jpg" class="photo" alt="" /></p>
				<p>
					Quisque varius ligula ac tortor interdum et feugiat nisl tristique. .
				</p>
			</div>
			<a href="#" class="readmore-small">read more...</a>
		</div>
		<div class="info-box">
			...
			<div class="align-content">
				<p><img src="images/img3.jpg" class="photo" alt="" /></p>
				<p>
					Proin mollis turpis quis turpis faucibus sed lobortis dolor adipiscing. 
				</p>
			</div>
			<a href="#" class="readmore-small">read more...</a>
		</div>
